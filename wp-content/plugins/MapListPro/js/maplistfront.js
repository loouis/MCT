jQuery(document).ready(function ($) {
    ...
    function MapViewModel(mapObject, mapid) {
        ...
        var infoWindowWidth = self.mapCanvas.width() * mapObject.options.infowidth;
        var infoWindowHeight = self.mapCanvas.height() * mapObject.options.infoheight;
        var categoriesmatchall = mapObject.options.categoriesmatchall;
        var hasZoomed = false;
        ...
        var preselectedCategories = mapObject.options.initiallyselectedcategories ? mapObject.options.initiallyselectedcategories.split(',') : null;
        ...
        // Map any custom taxonomies to KOP objects
        ...
        self.selectCategory = function (category, element) {
            ...
            if (mapObject.options.categoriesmultiselect === false) {
                ...
                if (mapObject.options.viewstyle === 'accordion' && category.selected) {
                    closeAllLocations();
                }
        ...
        */
        ...
        if (mapObject.options.viewstyle != 'listonly') {
            ...
            if (maplistScriptParamsKo.disableInfoBoxes == 'true') {
                self.infoBoxOptions = {maxWidth: infoWindowWidth};
                ...
                if (maplistScriptParamsKo.infoboxtype === "bubble") {
                    ...
                    self.infoBoxOptions.minHeight = infoWindowHeight;
                    self.infoBoxOptions.maxHeight = infoWindowHeight;
                    self.infoBoxOptions.minWidth = infoWindowWidth;
                    self.infoBoxOptions.maxWidth = infoWindowWidth;
                    ...
                    self.infoBoxOptions.pixelOffset = new google.maps.Size((infoWindowWidth / 2) * -1, -40);
 ...
 ****/
        ...
        self.showInfoWindow = function (location) {
            ...
            if (mapObject.options.hideinfowindow !== "true") {
                ...
                if (location.locationUrl !== '' && maplistScriptParamsKo.hideviewdetailbuttons != 'true') {
                    content += "<h3><a href='" + createLocationUrl(location) + "'>" + location.title + "</h3>";
                }                else {
                ...
                content += '<div class="infowindowContent" style="max-height:' + infoWindowHeight + 'px">';
            ...
            if (mapObject.options.keepzoomlevel == 'true' && hasZoomed === true) {
                // do nothing
            } else {
        ...
        function filterLocationsByCategory(locations, categories) {
            ...
            var matchAll = categoriesmatchall == "true";
        ...
        * UTILITIES
        ...
        function Category(title, slug, taxonomyName) {
            ...
            if (preselectedCategories !== null) {
                ...
                var selected = ko.utils.arrayFirst(preselectedCategories, function (selectedCat) {
