...
?>
	...
	<p class="wp-review-field">
		...
		<input type="hidden" name="wp_review_custom_width" id="wp_review_custom_width_unchecked" value="" />
	...
	<p class="wp-review-field">
		...
		<input type="hidden" name="wp_review_custom_author" id="wp_review_custom_author_unchecked" value="" />
...
function wp_review_render_meta_box_userReview( $post ) {
	...
	<p id="wp-review-through-comment-option" class="wp-review-field" <?php echo $enabled ? '' : 'style="display: none;"'; ?>>
		<label for="wp_review_through_comment" style="width: 30%">
			<input type="hidden" name="wp_review_through_comment" id="wp_review_through_comment_unchecked" value="0" />
			<input name="wp_review_through_comment" id="wp_review_through_comment" type="checkbox" value="1" <?php echo $review_through_comment ? 'checked ' : ''; ?> />
			<?php _e( 'Reviews Through Comments', 'wp-review' ); ?>
		</label>
	</p>
...
function wp_review_save_postdata( $post_id, $post ) {
	...
	$meta = array(
		...
		'wp_review_custom_author' => $_POST['wp_review_custom_author'],
		...
		'wp_review_through_comment'     => $_POST['wp_review_through_comment'],
		...
		'wp_review_width'    => $_POST['wp_review_width'],
		'wp_review_align'    => $_POST['wp_review_align'],
		'wp_review_author'    => $_POST['wp_review_author'],
	);
