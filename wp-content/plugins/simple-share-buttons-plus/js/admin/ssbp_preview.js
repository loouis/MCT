jQuery(document).ready(function() {
	...
	jQuery( "#default_style" ).change(function() {
		jQuery('#ssbp-preview--one').removeClass('ssbp--theme-1 ssbp--theme-2 ssbp--theme-3 ssbp--theme-4 ssbp--theme-5 ssbp--theme-6 ssbp--theme-7 ssbp--theme-8 ssbp--theme-9 ssbp--theme-10');
	...
	jQuery( "#two_style" ).change(function() {
		if(jQuery(this).val() == '') {
			...
			jQuery('#ssbp-preview--two').removeClass('ssbp--theme-1 ssbp--theme-2 ssbp--theme-3 ssbp--theme-4 ssbp--theme-5 ssbp--theme-6 ssbp--theme-7 ssbp--theme-8 ssbp--theme-9 ssbp--theme-10');
		}
		else {
