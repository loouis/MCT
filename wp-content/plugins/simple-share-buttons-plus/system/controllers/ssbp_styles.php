...
function ssbp_get_css()
{
    ...
    if ($ssbp_settings['custom_images'] != 'Y') {
        ...
        if ($ssbp_settings['one_responsive'] == 'Y') {
            ...
            $css .= str_replace('481px', (intval($ssbp_settings['one_breakpoint']) + 1) . 'px', $temp);
        } else {
            $css .= $temp;
        }
...
function ssbp_get_font_family()
{
    ...
    return "@font-face {
					font-family: 'ssbp';
					src:url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.eot?tpjxug');
					src:url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.eot?#iefixtpjxug') format('embedded-opentype'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.woff2?tpjxug') format('woff2'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.woff?tpjxug') format('woff'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.ttf?tpjxug') format('truetype'),
						url('".$plugins_url."/simple-share-buttons-plus/sharebuttons/assets/fonts/ssbp.svg?tpjxug#ssbp') format('svg');
					font-weight: normal;
					font-style: normal;
