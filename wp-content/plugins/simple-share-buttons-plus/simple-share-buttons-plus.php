...
Copyright 2014 - 2015 Simple Share Buttons admin@simplesharebuttons.com
...
if (strpos($ssbp_settings['selected_buttons'], 'ellipsis') !== false) {
    ...
    add_action('wp_footer', function() {
        ...
        // the buttons!
        echo $ssbpButtons->get_ssbp_buttons(ssbp_current_url(), get_the_title(), '', null, true);
